...
.comparison-caption-box { background-color: var(--secondary-background-color); border-left: 5px solid #6366f1; padding: 1rem 1.5rem; margin-top: 1rem; margin-bottom: 0.5rem; border-radius: 0.25rem; }
